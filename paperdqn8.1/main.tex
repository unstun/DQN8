...
本文其余部分组织如下：第~\ref{sec:method}节详细介绍所提框架的各组成模块，包括可通行性评估、运动学建模、MDP设计、网络结构与动作掩码机制；第~\ref{sec:results}节给出仿真与真实林地地图上的实验设置、对比结果与消融分析；第~\ref{sec:conclusion}节总结全文并展望未来工作。
