#!/usr/bin/env python3
"""Build unified paperstoryV1 archive.

Combines:
  - Forest from snapshot_20260305_2cat_v2 (v1 raw CSVs)
  - Realmap from snapshot_20260308_realmap_v7 (screen + baselines)
...
Usage:
    ...
    python scripts/build_paperstory_v1.py
"""
...
OUT = Path("runs/paperstoryV1/results")
...
def main():
    ...
    lines = [f"# Narrative Checks — paperstoryV1\n",
