#!/usr/bin/env python3
"""Build unified paperstoryV2 archive.

Combines:
  - Forest from snapshot_20260305_2cat_v2 (v1 raw CSVs)
  - Realmap from snapshot_20260308_realmap_v8 (screen + baselines, Joint-12/14 combo)
...
Usage:
    ...
    python scripts/build_paperstory_v2.py
"""
...
OUT = Path("runs/paperstoryV2/results")
...
def evaluate(df):
    ...
    # Per-pair minmax normalization (pool = all algos × all quality pairs)
    def nm(col):
...
def write_quality(quality, n_pairs, out_dir, dist):
    ...
    # Find best composite overall and best among DRL
...
def main():
    ...
    lines = [f"# Narrative Checks — paperstoryV2\n",
