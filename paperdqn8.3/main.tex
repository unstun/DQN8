...
\begin{figure}[t]
\centering
\subfloat[(a)]{\includegraphics[width=0.48\columnwidth]{image3.png}}
\hfill
\subfloat[(b)]{\includegraphics[width=0.48\columnwidth]{image4.png}}
...
如图~\ref{fig:dual_circle}所示，本文采用双圆足迹近似车体轮廓：沿车体纵轴布置两个半径为$r$的圆，分别覆盖前、后关键区域。记两圆心到最近障碍物的距离为$d_1$、$d_2$，当满足以下条件时判定为碰撞：
\begin{equation}
  \min(d_1,\, d_2) \leq r
\end{equation}
相比矩形足迹的多边形相交检测，圆形足迹仅需两次距离比较，计算效率更高。
...
\begin{figure}[t]
\centering
\subfloat[(a)]{\includegraphics[width=0.48\columnwidth]{image8.png}}
\hfill
\subfloat[(b)]{\includegraphics[width=0.48\columnwidth]{image9.png}}
...
\begin{figure}[t]
\centering
\subfloat[(a)]{\includegraphics[width=0.48\columnwidth]{image11.png}}
\hfill
\subfloat[(b)]{\includegraphics[width=0.48\columnwidth]{image12.png}}
